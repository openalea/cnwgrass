...
from openalea.growth import model
from openalea.respiration.model import RespirationModel
...
class Simulation(object):
    ...
    def __init__(self, delta_t=1, hydraulics=False, update_parameters=None):
        ...
        if not self.hydraulics:
            self.model = model.GrowthModel()
        else:
            self.model = model.GrowthModelHydraulics()
