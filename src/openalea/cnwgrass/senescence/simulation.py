...
from openalea.cnwgrass.senescence import model
from openalea.cnwgrass.senescence import parameters

"""
    senescence.simulation
    ~~~~~~~~~~~~~~~~~~~~~~~~

    The module :mod:`senescence.simulation` is the front-end to run the Senescence :mod:`model <senescence.model>`.
...
class Simulation(object):
    ...
    def run(self, forced_max_protein_elements=None, opt_full_remob=False, postflowering_stages=False):
        """
        Compute Senescence outputs from :attr:`inputs`, and update :attr:`outputs`.
