...
"""
    ...
    The module :mod:`hydraulics.parameters` defines the parameters of the model.
...
RATIO_MSTRUCT_DM = 0.8  #: Ratio mstruct/dry matter (dimensionless). From growth model.
...
#: The instance of class :class:`hydraulics.parameters.PopulationParameters` for current process
...
#: The instance of class :class:`hydraulics.parameters.PlantParameters` for current process
...
#: The instance of class :class:`hydraulics.parameters.AxisParameters` for current process
...
#: The instance of class :class:`hydraulics.parameters.PhytomerParameters` for current process
...
#: The instance of class :class:`hydraulics.parameters.HiddenZoneParameters` for current process
...
#: The instance of class :class:`hydraulics.parameters.HiddenZoneInitCompartments` for current process
...
#: The instance of class :class:`cnmetabolism.parameters.XylemParameters` for current process
...
#: The instance of class :class:`cnmetabolism.parameters.XylemInitCompartments` for current process
...
#: The instance of class :class:`hydraulics.parameters.LaminaInitCompartments` for current process
...
#: The instance of class :class:`hydraulics.parameters.LaminaParameters` for current process
...
#: The instance of class :class:`hydraulics.parameters.LaminaElementInitCompartments` for current process
...
#: The instance of class :class:`hydraulics.parameters.InternodeParameters` for current process
...
#: The instance of class :class:`hydraulics.parameters.InternodeElementInitCompartments` for current process
...
#: The instance of class :class:`hydraulics.parameters.SheathElementInitCompartments` for current process
...
class SoilParameters(object):
    ...
    def __init__(self):
        ...
        self.Soil_a = 15.906  #: Mpa - Parameter for soil water function (adapt� pour sol limono-argileux profond, Grignon)
        self.Soil_b = 18.902  #: % - Parameter for soil water function (adapt� pour sol limono-argileux profond, Grignon)
