...
"""
    ...
    The module :mod:`morphogenesis.parameters` defines the constant parameters.
...
class Parameters(object):
    def __init__(self):
        ...
        # --- Leaves
        # -------------------------------------------------------------------------------------------------------------------
        self.conc_sucrose_offset = 240  #: sucrose concentration under which no leaf and internode growth occurs (�mol of C g-1 mstruct) - same for root growth, see growth
        ...
        self.RER_Kc = 100  #: affinity coefficient of RER to C (�mol g-1)
        self.RER_Kn = 15  #: affinity coefficient of RER to N (�mol g-1)
        ...
        self.leaf_pseudo_age_Kc = 150  #: affinity coefficient to C (�mol g-1)
        self.leaf_pseudo_age_Kn = 4  #: affinity coefficient to N (�mol g-1)
        ...
        self.leaf_SSLW_b = 2927.944  # �mol C g-1
        ...
        # Parameters are used for an inverse beta function representing the ratio of the leaf composed by the division zone according to its relative length in log.
        # The model was fitted on literature data on wheat (Fournier 2005, Beemster and Masle 1996, Schuppler 1998).
        ...
        self.nb_PLASTO_internode_init = 5  #: Delay between leaf initiation and internode initiation expressed as a number of plastochron. From Malvoisin 1984b, associated with primordia of 5.10-4 m
    ...
    def delta_TT_GA(self, value):
        """ Allows the value to be modified externally from simulation.py"""
        self._delta_TT_GA = value
...
class HiddenZoneInit(object):
    ...
    def __init__(self):
        ...
        self.delta_internode_distance_to_emerge = 0  #: m, needed for growth
        self.leaf_L = 5E-5  #: m, should be consistent with PLASTOCHRONE
        self.delta_leaf_L = 0  #: m, needed for growth
        self.internode_L = 0  #: m
        self.delta_internode_L = 0  #: m, needed for growth
...
class HiddenZoneInitHydraulics(HiddenZoneInit):
    ...
    def __init__(self):
        ...
        self.init_leaf_L = 0  #: m, needed for growth
