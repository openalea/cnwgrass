...
class ElongWheatFacade(object):
    ...
    def run(self, Tair, Tsoil, Zsowing=0.025, update_shared_df=None):
        ...
        if self.seed_is_moistened:
            ...
            if update_shared_df or (update_shared_df is None and self._update_shared_df):
                elongwheat_hiddenzones_outputs_df, elongwheat_elements_outputs_df, elongwheat_SAM_temperature_outputs_df = converter.to_dataframes(self._simulation.outputs, self._simulation.axis_outputs, self._simulation.hiddenzone_outputs, self._simulation.element_outputs)
        ...
        for mtg_plant_vid in self._shared_mtg.components_iter(self._shared_mtg.root):
            ...
            for mtg_axis_vid in self._shared_mtg.components_iter(mtg_plant_vid):
                ...
                for mtg_metamer_vid in self._shared_mtg.components_iter(mtg_axis_vid):
                    ...
                    elongwheat_hiddenzone_data_from_mtg_organs_data = {}  # TODO: still useful?
                    ...
                    for mtg_organ_vid in self._shared_mtg.components_iter(mtg_metamer_vid):
                        ...
                        for mtg_element_vid in self._shared_mtg.components_iter(mtg_organ_vid):
                            ...
                            if set(mtg_element_properties).issuperset(self._simulation.element_inputs):
                                ...
                                for elongwheat_element_input_name in self._simulation.element_inputs:
    ...
    def _update_shared_MTG(self, all_elongwheat_hiddenzones_data_dict, all_elongwheat_elements_data_dict, all_elongwheat_axes_data_dict, option_static=False):
        ...
        for elongwheat_data_name in set(self._simulation.hiddenzone_inputs_outputs + self._simulation.element_inputs_outputs + self._simulation.axis_inputs_outputs):
