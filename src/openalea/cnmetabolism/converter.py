...
from openalea.cnmetabolism import model, simulation
            ...
            for axis_label in curr_axes_labels:
                ...
                for metamer_index in curr_metamers_indexes:
                    ...
                    if metamer_index in curr_metamers_indexes_for_hiddenzones:
                        ...
                        hiddenzone = model.HiddenZone(CNMETABOLISM_CLASSES_TO_DATAFRAME_ORGANS_MAPPING[model.HiddenZone], **hiddenzone_dict)
