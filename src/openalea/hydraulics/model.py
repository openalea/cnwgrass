...
from openalea.hydraulics import parameters
...
class PhotosyntheticOrganElement:
    ...
    def calculate_delta_turgor_water_potential(volume, delta_water_content):
        ...
        delta_turgor_water_potential = ((1 / (parameters.RHO_WATER * volume * parameters.VSTORAGE)) * delta_water_content - plastic_component) * elastic_component  #: (MPa)
