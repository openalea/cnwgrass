...
from openalea.turgorgrowth import simulation as turgorgrowth_simulation, parameters as turgorgrowth_parameters
...
def postprocessing(plants_df=None, axes_df=None, metamers_df=None, hiddenzones_df=None, organs_df=None, elements_df=None, soils_df=None, delta_t=1):
    ...
    :param pandas.DataFrame organs_df: Turgor-Growth outputs at xylem scale (see :attr:`simulation.Simulation. ORGAN_RUN_VARIABLES`)
...
def generate_graphs(axes_df=None, hiddenzones_df=None, organs_df=None, elements_df=None, soils_df=None, meteo_data=None, graphs_dirpath='.'):
    ...
    :param pandas.DataFrame organs_df: Turgor-Growth outputs at organ scale (see :attr:`ORGANS_RUN_POSTPROCESSING_VARIABLES`)
