...
class ElongWheatModel(object):
    def __init__(self):
        self.parameters = elongwheat_parameters.parameters_factory()
        self.hiddenzone_init = elongwheat_parameters.HiddenZoneInit()
        self.element_init = elongwheat_parameters.ElementInit()
    ...
    def calculate_lamina_L(leaf_L, leaf_pseudostem_length, lamina_Lmax):
        ...
        return max(10 ** -5,
                   min(lamina_L,
                       lamina_Lmax))  # Minimum length set to 10^-5 m to make sure growth-wheat can run even if the lamina turns back hidden (case when an older sheath elongates faster)
...
class ElongWheatModelHydraulics(ElongWheatModel):
    def __init__(self):
        super().__init__()
        self.parameters = elongwheat_parameters.parameters_factory(hydraulics=True)
        self.hiddenzone_init = elongwheat_parameters.HiddenZoneInitHydraulics()
