...
from openalea.cnwgrass.cnmetabolism import model as cnmetabolism_model
...
def table_C_usages(scenario_postprocessing_dirpath):
    ...
    AMINO_ACIDS_C_RATIO = cnmetabolism_model.EcophysiologicalConstants.AMINO_ACIDS_C_RATIO  #: Mean number of mol of C in 1 mol of the major amino acids of plants (Glu, Gln, Ser, Asp, Ala, Gly)
    AMINO_ACIDS_N_RATIO = cnmetabolism_model.EcophysiologicalConstants.AMINO_ACIDS_N_RATIO  #: Mean number of mol of N in 1 mol of the major amino acids of plants (Glu, Gln, Ser, Asp, Ala, Gly)
